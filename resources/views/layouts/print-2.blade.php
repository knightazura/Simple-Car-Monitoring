...
<div class="container" style="border: 3px double #999">
  ...
  <!-- 1st table -->
  <div class="row justify-content-md-center pb-3" style="border-bottom: 1px dashed #999; font-size: 10pt">
    <div class="col-md-12">
      <table>
  ...
  <div class="row justify-content-md-center mt-3" style="font-size: 10pt">
    <div class="col-md-12">
      <table>
        <tr>
          <td colspan="4" class="w-40">
